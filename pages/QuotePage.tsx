...
const QuotePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedServices.length === 0) {
        setServerMessage("Please select at least one service.");
        return;
    }
          ...
          <div className="max-w-4xl mx-auto bg-kayjay-light-gray p-8 rounded-lg shadow-xl" data-aos="fade-up">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-kayjay-blue mb-6 border-b-2 border-kayjay-gold pb-2">Select Services</h3>
                    ...
                    {services.map(service => (
                      <div key={service} className="flex items-center">
                        <input
                          ...
                          className="h-5 w-5 text-kayjay-blue border-gray-300 rounded focus:ring-kayjay-gold"
                        />
                ...
                <div>
                  <h3 className="text-2xl font-bold text-kayjay-blue mb-6 border-b-2 border-kayjay-gold pb-2">Your Details</h3>
