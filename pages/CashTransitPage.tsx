...
const ServiceCard: React.FC<{ title: string; children: React.ReactNode; icon: React.ReactNode }> = ({ title, children, icon }) => (
  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col items-center text-center h-full">
  ...
  return (
    <div>
      ...
      <section className="py-16 md:py-24 bg-kayjay-light-gray">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center text-kayjay-blue mb-12" data-aos="fade-up">Our Cash Transit Services</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                {benefits.map((benefit, index) => (
                    <div key={benefit.title} data-aos="zoom-in" data-aos-delay={index * 100} className="bg-kayjay-light-gray p-6 rounded-lg shadow-md text-center">
