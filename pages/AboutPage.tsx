...
const AboutPage: React.FC = () => {
  return (
    <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-lg text-gray-700 space-y-4" data-aos="fade-left">
              <h2 className="text-3xl font-bold text-kayjay-blue mb-4">Our Story as a Top Security Company in Sri Lanka</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-kayjay-blue mb-12" data-aos="fade-up">Our Core Values</h2>
