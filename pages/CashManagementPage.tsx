        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-lg text-gray-700 space-y-4" data-aos="fade-left">
              <h2 className="text-3xl font-bold text-kayjay-blue mb-4">About Our Cash Management Services</h2>
      ...
      <section className="py-16 md:py-24 bg-kayjay-light-gray">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="0">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div data-aos="fade-left">
                  <h2 className="text-3xl font-bold text-kayjay-blue mb-4">Our Team of Professional Security Guards</h2>
                  <ul className="space-y-3 text-gray-700">
